(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["serverlessAlexaPlugin"] = factory();
	else
		root["serverlessAlexaPlugin"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ServerlessAlexaPlugin = function () {
	  function ServerlessAlexaPlugin(serverless) {
	    _classCallCheck(this, ServerlessAlexaPlugin);
	  ...
	  _createClass(ServerlessAlexaPlugin, [{
	    key: 'compileAlexaEvents',
	    value: function compileAlexaEvents() {
	      var _this = this;
	      ...
	      this.serverless.service.getAllFunctions().forEach(function (functionName) {
	        ...
	        if (functionObj.events) {
	          for (var i = 0; i < functionObj.events.length; i++) {
	            var event = functionObj.events[i];
	            if (event === 'alexaSkillsKit' || event.alexaSmartHome) {
	              ...
	              (0, _lodash.merge)(_this.serverless.service.resources.Resources, newPermissionObject);
	            }
	          }
	        }
	      });
...
;
//# sourceMappingURL=serverless-alexa-plugin.js.map